...
S
混合型インスリン製剤（超速効型＋持効型）の使用により軽いふらつきや冷汗などがあるが、糖分摂取により改善している。
O
混合型インスリン製剤（超速効型＋持効型）　処方
A
混合型インスリン製剤（超速効型＋持効型）による軽度の低血糖症状を認めるが、対応により改善しており、治療継続は可能である。
P
低血糖症状が出た場合は、速やかにブドウ糖や糖分を摂取してください。
...
S
混合型インスリン製剤（超速効型＋持効型）の使用により注射部位に軽い痛みやしこりがあるが、日常生活は送れている。
O
混合型インスリン製剤（超速効型＋持効型）　処方
A
...
P
混合型インスリン製剤（超速効型＋持効型）による症状が強い場合は、減量や薬の変更などが必要になることがあります。
処方医へご相談ください。
P_CLOSING
次回、治療経過および副作用の有無を確認。
...
P
混合型インスリン製剤（超速効型＋持効型）により注射部位の痛みや腫れが強い場合は、使用方法の見直しや薬の変更が必要になることがあります。
症状が続く場合は処方医へご相談ください。
P_CLOSING
次回、治療経過および副作用の有無を確認。
