...
【SCENARIO｜type=treatment_adjustment｜id=dose_decrease_improved｜title=GLP-1受容体作動薬(内服) 減量（検査値改善）】
S
...
P
GLP-1受容体作動薬(内服)による消化器症状がある場合は、少量ずつ食事を摂り、脂っこい食事を控えることで改善することがあります。
水分を十分に摂るよう心がけてください。
