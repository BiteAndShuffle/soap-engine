...
constitution:
  ...
  editingRules:
    ...
    - "全体状態評価シナリオ（例：CP良好など）では、Sフィールドの主語省略を許容する"
...
【SCENARIO｜type=side_effect｜id=se_dose_decrease_due_to_injection_site_reaction｜title=GLP-1受容体作動薬(注射) SE減量（注射部位）】
S
GLP-1受容体作動薬(注射)の使用により注射部位の痛みや腫れが強いため、減量となった。

O
GLP-1受容体作動薬(注射)　減量

A
GLP-1受容体作動薬(注射)による注射部位反応を認め、減量後の経過確認を要する。

P
GLP-1受容体作動薬(注射)の減量後も注射部位の症状が続く場合はご相談ください。
注射部位は毎回適切に変えながら使用することで、症状の軽減につながることがあります。
