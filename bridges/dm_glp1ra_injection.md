...
【SCENARIO｜type=treatment_adjustment｜id=dose_decrease_improved｜title=GLP-1受容体作動薬(注射) 減量（検査値改善）】
S
...
P
GLP-1受容体作動薬(注射)による消化器症状がある場合は、少量ずつ食事を摂り、脂っこい食事を控えることで改善することがあります。
水分を十分に摂るよう心がけてください。
...
P
GLP-1受容体作動薬(注射)を使用する際は、毎回注射する場所を少しずつ変えることで、痛みや腫れの予防・軽減につながることがあります。
