...
【SCENARIO｜type=treatment_adjustment｜id=dose_decrease_improved｜title=GIP/GLP-1受容体作動薬（注射） 減量（検査値改善）】
S
...
【SCENARIO｜type=side_effect｜id=se_mild_continue｜title=GIP/GLP-1受容体作動薬（注射） SE継続（軽症 消化器症状）】
S
...
便秘や下痢などの症状が強く続く場合は調整が必要なことがありますので、ご相談ください。
...
【SCENARIO｜type=side_effect｜id=se_injection_site_reaction_mild_continue｜title=GIP/GLP-1受容体作動薬（注射） SE継続（軽症 注射部位）】
S
...
【SCENARIO｜type=side_effect｜id=se_moderate_consider_dr｜title=GIP/GLP-1受容体作動薬（注射） SE継続（中等度 消化器症状）】
S
...
P
GIP/GLP-1受容体作動薬（注射）による消化器症状がある場合は、少量ずつ食事を摂り、脂っこい食事を控えることで改善することがあります。
水分を十分に摂るよう心がけてください。
症状が強く続く場合は、減量や薬の変更、症状に応じた薬の追加が必要になることがあります。
自己判断せず、処方医へご相談ください。
...
【SCENARIO｜type=side_effect｜id=se_injection_site_reaction_moderate_consider_dr｜title=GIP/GLP-1受容体作動薬（注射） SE継続（中等度 注射部位）】
S
...
P
GIP/GLP-1受容体作動薬（注射）を使用する際は、毎回注射する場所を少しずつ変えることで、痛みや腫れの予防・軽減につながることがあります。
注射部位の痛みや腫れが強く続く場合は、使用方法の見直しや薬の変更が必要になることがあります。
自己判断せず、処方医へご相談ください。
