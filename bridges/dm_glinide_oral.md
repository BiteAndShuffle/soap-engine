...
# およびシナリオ本文を、会話ログではなくリポジトリ上に固定するための作業ファイルです
# （2026-07-07 ヘッダー作成、同日シナリオ本文追加）。
#
# シナリオ本文追加時の対応: addon_hyperkalemia_guidance はユーザー提供文の時点で
...
=======SCENARIOS_START=======
【SCENARIO｜type=treatment_start｜id=initial｜title=グリニド系経口血糖降下剤 初回】
S
グリニド系経口血糖降下剤は、血糖値が高いため追加となった。
O
グリニド系経口血糖降下剤　処方
A
グリニド系経口血糖降下剤は、血糖コントロール不十分のため追加となった。
速やかに膵臓からのインスリン分泌を促すことで、食後血糖の改善を目的として服用する。
P
グリニド系経口血糖降下剤は、食後血糖を改善する薬です。
...
【ADDON｜type=adherence_guidance｜id=addon_glinide_before_meal_guidance｜title=グリニド服用タイミング｜uiGroup=薬剤固有介入｜uiVariant=rightAccentAmber】
P_APPEND
食事の直前に服用する薬です。
食事を摂らない時は、低血糖を避けるため服用を控え、対応に迷う場合は処方医へご相談ください。
飲み忘れた場合は、食後に追加で服用せず、次回の食事前から通常どおり服用してください。
...
【SCENARIO｜type=treatment_start｜id=restart｜title=グリニド系経口血糖降下剤 再開】
S
グリニド系経口血糖降下剤は、血糖値が高いため再開となった。
O
グリニド系経口血糖降下剤　処方
A
グリニド系経口血糖降下剤は、血糖コントロール不十分のため再開となった。
速やかに膵臓からのインスリン分泌を促すことで、食後血糖の改善を目的として服用する。
P
グリニド系経口血糖降下剤は、食後血糖を改善する薬です。
服用中は、ふらつき・冷汗・動悸などの低血糖症状が出ることがあります。
...
【SCENARIO｜type=treatment_start｜id=external_start｜title=グリニド系経口血糖降下剤 他所開始】
S
グリニド系経口血糖降下剤は、他院で開始され継続使用中であった。
O
グリニド系経口血糖降下剤　処方
A
グリニド系経口血糖降下剤は、血糖コントロール改善を目的として使用中であった。
速やかに膵臓からのインスリン分泌を促すことで、食後血糖の改善を目的として服用する。
P
グリニド系経口血糖降下剤は、食後血糖を改善する薬です。
服用中は、ふらつき・冷汗・動悸などの低血糖症状が出ることがあります。
...
【SCENARIO｜type=treatment_adjustment｜id=dose_increase_low_perceived_effect｜title=グリニド系経口血糖降下剤 増量（効果実感乏しい）】
S
グリニド系経口血糖降下剤は、効果の実感が乏しいため増量となった。
O
グリニド系経口血糖降下剤　増量
A
グリニド系経口血糖降下剤は、効果不十分のため増量となった。増量に伴い副作用が増強する可能性があるため、注意が必要である。
P
グリニド系経口血糖降下剤は、増量によりふらつき・冷汗・動悸などの低血糖症状が出ることがあります。
低血糖症状が出た場合は、まずブドウ糖を摂取して対処してください。ブドウ糖がない場合は、糖分を含む飲食物で対応してください。
P_CLOSING
次回、引き続き使用できているか、副作用の有無を確認。
...
【SCENARIO｜type=treatment_adjustment｜id=dose_increase_no_lab_improvement｜title=グリニド系経口血糖降下剤 増量（検査値改善なし）】
S
グリニド系経口血糖降下剤は、検査値が改善しないため増量となった。
O
グリニド系経口血糖降下剤　増量
A
グリニド系経口血糖降下剤は、検査値改善が不十分なため増量となった。増量に伴い副作用が増強する可能性があるため、注意が必要である。
P
グリニド系経口血糖降下剤は、増量によりふらつき・冷汗・動悸などの低血糖症状が出ることがあります。
低血糖症状が出た場合は、まずブドウ糖を摂取して対処してください。ブドウ糖がない場合は、糖分を含む飲食物で対応してください。
P_CLOSING
...
【SCENARIO｜type=treatment_adjustment｜id=dose_increase_due_to_other_med_adjustment｜title=グリニド系経口血糖降下剤 増量（他剤との調整）】
S
グリニド系経口血糖降下剤は、他剤変更に伴う調整により増量となった。
O
グリニド系経口血糖降下剤　増量
A
グリニド系経口血糖降下剤は、他剤変更に伴う調整のため増量となった。増量に伴い副作用が増強する可能性があるため、注意が必要である。
P
グリニド系経口血糖降下剤は、増量によりふらつき・冷汗・動悸などの低血糖症状が出ることがあります。
低血糖症状が出た場合は、まずブドウ糖を摂取して対処してください。ブドウ糖がない場合は、糖分を含む飲食物で対応してください。
P_CLOSING
...
【SCENARIO｜type=treatment_adjustment｜id=dose_decrease_renal_function｜title=グリニド系経口血糖降下剤 減量（腎機能低下）】
S
グリニド系経口血糖降下剤は、腎機能を考慮して減量となった。
O
グリニド系経口血糖降下剤　減量
A
グリニド系経口血糖降下剤は、腎機能低下に伴い用量調整となった。減量後の血糖推移に注意が必要である。
P
グリニド系経口血糖降下剤は、腎機能に応じて用量調整が必要になることがあります。
...
【SCENARIO｜type=treatment_adjustment｜id=dose_decrease_improved｜title=グリニド系経口血糖降下剤 減量（検査値改善）】
S
グリニド系経口血糖降下剤は、検査値が改善したため減量となった。
O
グリニド系経口血糖降下剤　減量
A
グリニド系経口血糖降下剤は、血糖推移を踏まえ減量となった。減量後に血糖が上昇する可能性があるため、注意が必要である。
P
グリニド系経口血糖降下剤は、減量により血糖値が上がることがあります。
体調変化があればご相談ください。
P_CLOSING
次回、引き続き使用できているか、副作用の有無を確認。
...
【SCENARIO｜type=treatment_adjustment｜id=dose_decrease_low_perceived_effect｜title=グリニド系経口血糖降下剤 減量（効果実感乏しい）】
S
グリニド系経口血糖降下剤は、効果の実感が乏しいため減量を希望された。
O
グリニド系経口血糖降下剤　減量
A
グリニド系経口血糖降下剤は、患者希望を踏まえ減量となった。減量後の血糖推移に注意が必要である。
P
グリニド系経口血糖降下剤は、減量により血糖値が上昇する可能性があります。
体調変化があればご相談ください。
P_CLOSING
次回、引き続き使用できているか、副作用の有無を確認。
...
【SCENARIO｜type=treatment_adjustment｜id=dose_decrease_due_to_other_med_adjustment｜title=グリニド系経口血糖降下剤 減量（他剤との調整）】
S
グリニド系経口血糖降下剤は、他剤変更に伴う調整のため減量となった。
O
グリニド系経口血糖降下剤　減量
A
グリニド系経口血糖降下剤は、併用薬変更に伴う血糖調整のため減量となった。減量後の血糖推移に注意が必要である。
P
グリニド系経口血糖降下剤は、減量により血糖値が上昇する可能性があります。
体調変化があればご相談ください。
P_CLOSING
...
【SCENARIO｜type=side_effect｜id=se_hypo_none｜title=グリニド系経口血糖降下剤 副作用なし（低血糖）】
S
グリニド系経口血糖降下剤を服用して症状は落ち着いている。
ふらつき・冷汗・動悸などの低血糖症状は認めない。
O
グリニド系経口血糖降下剤　処方
A
グリニド系経口血糖降下剤による低血糖は現時点で認められず、治療継続が可能である。
P
グリニド系経口血糖降下剤の継続中に、ふらつき・冷汗・動悸などの低血糖症状が出ることがあります。
...
【SCENARIO｜type=side_effect｜id=se_liver_dysfunction_none｜title=グリニド系経口血糖降下剤 副作用なし（肝障害関連症状）】
S
グリニド系経口血糖降下剤を服用して症状は落ち着いている。
...
グリニド系経口血糖降下剤　処方
A
グリニド系経口血糖降下剤による肝障害を疑う明らかな自覚症状は現時点で認められず、治療継続が可能である。
P
グリニド系経口血糖降下剤の継続中に、強い倦怠感が出ることがあります。
気になる症状が続く場合はご相談ください。
P_ADDON
- addon_glycemic_guidance_followup
- addon_hyperkalemia_guidance
...
【SCENARIO｜type=side_effect｜id=se_anemia_none｜title=グリニド系経口血糖降下剤 副作用なし（貧血）】
S
グリニド系経口血糖降下剤を服用して症状は落ち着いている。
疲れやすさやだるさなどの症状は認めない。
O
グリニド系経口血糖降下剤　処方
A
グリニド系経口血糖降下剤による貧血は現時点で認められず、治療継続が可能である。
P
グリニド系経口血糖降下剤の継続中に、貧血が出ることがあります。
...
【SCENARIO｜type=treatment_end｜id=end_improved｜title=グリニド系経口血糖降下剤 終了（改善）】
S
グリニド系経口血糖降下剤は、血糖コントロールが改善したため中止となった。
O
グリニド系経口血糖降下剤　処方終了
A
グリニド系経口血糖降下剤は、血糖コントロールの改善により終了となった。終了後に血糖が変動する可能性があるため、注意が必要である。
P
グリニド系経口血糖降下剤終了後、血糖上昇や体調変化がある場合はご相談ください。
P_CLOSING
...
【SCENARIO｜type=treatment_end｜id=end_insufficient_effect｜title=グリニド系経口血糖降下剤 終了（効果不十分）】
S
グリニド系経口血糖降下剤は、効果不十分のため中止となった。
O
グリニド系経口血糖降下剤　処方終了
A
グリニド系経口血糖降下剤は、効果不十分のため終了となった。血糖管理の再評価が必要である。
P
グリニド系経口血糖降下剤終了後、血糖が上昇する可能性があります。
...
【SCENARIO｜type=treatment_end｜id=end_ineffective｜title=グリニド系経口血糖降下剤 終了（無効）】
S
グリニド系経口血糖降下剤は、効果が認められなかったため中止となった。
O
グリニド系経口血糖降下剤　処方終了
A
グリニド系経口血糖降下剤は、効果が認められなかったため終了となった。治療方針の変更が必要である。
P
グリニド系経口血糖降下剤終了後、血糖が上昇する可能性があります。
...
【SCENARIO｜type=side_effect｜id=se_mild_continue｜title=グリニド系経口血糖降下剤 SE継続（軽症 低血糖）】
S
グリニド系経口血糖降下剤の服用により軽い低血糖が出ることがあるが、日常生活は送れている。
O
グリニド系経口血糖降下剤　処方
A
グリニド系経口血糖降下剤による低血糖症状を軽度認めるが、治療継続が可能である。
P
グリニド系経口血糖降下剤による症状が軽い場合は、まずブドウ糖を摂取して対処してください。ブドウ糖がない場合は、糖分を含む飲食物で対応してください。
...
【SCENARIO｜type=side_effect｜id=se_change_due_to_hypoglycemia｜title=グリニド系経口血糖降下剤 SE変更（低血糖）】
S
グリニド系経口血糖降下剤の服用により低血糖が出現したため、他剤へ変更となった。
O
グリニド系経口血糖降下剤　処方変更
A
グリニド系経口血糖降下剤の服用による低血糖症状を認め、他剤変更後の経過確認を要する。
P
グリニド系経口血糖降下剤の変更後、血糖上昇や体調変化があればご相談ください。
P_CLOSING
次回、治療経過および副作用の有無を確認。
...
【SCENARIO｜type=side_effect｜id=se_dose_decrease_due_to_hypoglycemia｜title=グリニド系経口血糖降下剤 SE減量（低血糖）】
S
グリニド系経口血糖降下剤の服用により低血糖がひどいため、減量となった。
O
グリニド系経口血糖降下剤　減量
A
グリニド系経口血糖降下剤の服用による低血糖症状を認め、減量後の経過確認を要する。
P
グリニド系経口血糖降下剤の減量後も低血糖症状が続く場合はご相談ください。
P_CLOSING
次回、治療経過および副作用の有無を確認。
...
【SCENARIO｜type=side_effect｜id=se_stop_due_to_hypoglycemia｜title=グリニド系経口血糖降下剤 SE中止（低血糖）】
S
グリニド系経口血糖降下剤の服用により低血糖がひどいため、中止となった。
O
グリニド系経口血糖降下剤　処方中止
A
グリニド系経口血糖降下剤の服用による低血糖症状を認め、中止後の経過確認を要する。
P
グリニド系経口血糖降下剤の中止後、血糖上昇や体調変化があればご相談ください。
P_CLOSING
次回、治療経過および副作用の有無を確認。
...
【SCENARIO｜type=lifestyle_guidance｜id=lifestyle_guidance_hyperglycemia｜title=グリニド系経口血糖降下剤 生活指導（血糖）】
S
血糖値がなかなか改善しない。
O
グリニド系経口血糖降下剤　処方
...
【SCENARIO｜type=lifestyle_guidance｜id=lifestyle_guidance_hyperkalemia｜title=グリニド系経口血糖降下剤 生活指導（カリウム）】
S
カリウムの値が高いと言われた。
O
グリニド系経口血糖降下剤　処方
...
【SCENARIO｜type=sickday｜id=sickday｜title=グリニド系経口血糖降下剤 シックデイ】
S
