...
メトホルミンによる肝臓での糖新生抑制に加え、チアゾリジン系薬によるインスリン抵抗性改善により、血糖改善を目的として服用する。
P
...
P
チアゾリジン系糖尿病薬・メトホルミン配合剤は、増量によりお腹の調子が悪くなることがあります。
消化器症状が強い場合はご相談ください。
P_ADDON
- addon_se_hypoglycemia_guidance
P_CLOSING
...
この薬は低血糖を起こしにくい薬ですが、他の糖尿病薬と併用中は低血糖が起こることがあります。
