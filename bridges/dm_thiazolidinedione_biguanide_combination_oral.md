...
服用中は、むくみや、下痢・吐き気などのお腹の不調が出ることがあります。
...
P_APPEND
発熱・嘔吐・下痢などで食事や水分が十分に摂れない場合は、脱水により乳酸アシドーシスなどの重い副作用のリスクが高まることがあります。
医師から水分制限を指示されていない場合は、水分を少量ずつこまめに摂取してください。
嘔吐が続く、水分が十分に摂れない、尿量が減る、強い倦怠感、吐き気、腹痛、息苦しさなどがある場合は、速やかに医療機関を受診してください。
...
P
チアゾリジン系糖尿病薬・メトホルミン配合剤による症状が軽い場合は、水分を少量ずつこまめに摂取してください。
症状が強い、または続く場合は、薬の調整が必要になることがあります。
...
P
チアゾリジン系糖尿病薬・メトホルミン配合剤による下痢がみられる場合は、水分を少量ずつこまめに摂取してください。
