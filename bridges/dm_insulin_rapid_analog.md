...
P_CLOSING
次回、引き続き使用できているか、副作用の有無を確認。
【SCENARIO｜type=treatment_adjustment｜id=dose_decrease_improved｜title=超速効型インスリン製剤 減量（検査値改善）】
S
...
超速効型インスリン製剤　処方
A
超速効型インスリン製剤による低血糖症状を軽度認めるが、治療継続が可能である。
P
超速効型インスリン製剤による低血糖症状が軽い場合は、ブドウ糖や糖分を摂取して対処してください。
...
P
超速効型インスリン製剤による低血糖症状がある場合は、まずブドウ糖を摂取して対処してください。ブドウ糖がない場合は、糖分を含む飲食物で対応してください。
食事量が少ない時や食事時間が遅れる時は、低血糖が起こりやすくなることがあります。
...
P
超速効型インスリン製剤を使用する際は、毎回注射部位を少しずつ変えて注射することで、痛みや腫れの予防・軽減につながります。
