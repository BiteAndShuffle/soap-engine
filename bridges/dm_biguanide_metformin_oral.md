...
#     SCENARIOS_START〜SCENARIOS_END として追加済み（2026-07-05）。
#     全29シナリオ・ADDON定義16件（ただし addon_hyperkalemia_guidance の定義ブロックが
#     initial 後・se_hypo_none 後の2箇所に重複して記載されている。ユーザー提供文の
#     そのままの記載であり、本追加作業では修正していない。ユーザー確認・凍結宣言時に
#     意図的な重複か整理が必要かご確認ください）。
#
# =========================================
# 残る未確定事項（PENDING）
# =========================================
...
【SCENARIO｜type=treatment_adjustment｜id=dose_decrease_improved｜title=ビグアナイド系糖尿病薬 減量（症状改善）】
S
...
脱水や体調不良時には、まれに乳酸アシドーシスのリスクが高まることがあります。
